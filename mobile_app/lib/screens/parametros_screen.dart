...
class _ParametrosScreenState extends State<ParametrosScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _updatePermissions(dynamic user, String field, bool value) async {
    ...
    // Reemplazar el campo que cambió
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  obscureText: true,
                  decoration: const InputDecoration(labelText: 'PIN de Seguridad (Números)'),
                ),
                const SizedBox(height: 12),
  ...
  Widget _buildPersonalTab() {
    if (_usuarios.isEmpty) {
      return const Center(child: Text('No hay colaboradores registrados.', style: TextStyle(fontStyle: FontStyle.italic, color: AppTheme.textMuted)));
    }
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          bottom: TabBar(
            ...
            tabs: const [
              Tab(text: 'Empresa / Recibo'),
              Tab(text: 'Personal / Accesos'),
            ],
          ),
        ),
      ),
